...
5. example_inputs/simple5.hl: uninitialized variable, which will cause an error (The error message shows i is not defined in the condition part of the while statement)
